...
readonly B2_REPOSITORY="s3:https://s3.us-east-005.backblazeb2.com/kgivler-backup-scopecreep"
...
restic \
    ...
    cat config \
    >/dev/null ||
    die "Unable to access ScopeCreep repository on Clanker."
...
restic \
    ...
    cat config \
    >/dev/null ||
    die "Unable to access ScopeCreep repository on Backblaze B2."
